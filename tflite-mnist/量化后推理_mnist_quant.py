...
model_path = "./quant_model/tflite_quant_model.tflite"
...
for i in range(0,21):
    ...
    # img2_0= img.astype(np.uint8)
    # # img2_0=np.round(img).astype(int)
    # img2 = cv2.resize(img2_0, (168, 168))
    ...
    res1.append(np.argmax(result))
    str1="mnist_quant/iter_"+ '%s.txt' % (i)
